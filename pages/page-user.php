<div class="row user">
  <div class="col-md-12">
    <div class="profile">
      <div class="info"><img class="user-img" src="https://avatars2.githubusercontent.com/u/13075784?s=460&u=f7dc296db848c3f39d893d7e6aa95acd5a771bd5&v=4">
        <h4>John Doe</h4>
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="user-timeline">
        <div class="timeline-post">
          <div class="post-media"><a href="#"><img src="https://lh3.googleusercontent.com/proxy/KfiKetdwqV8ZzSGvjJKrAvpGzp7Rq7pJK3XLeL_KgRgsdqdCPgwgD79Y7nVaUqsrX-8r6nUhp3_3tWL0XLNTGpxjnoTW-GY"></a>
            <div class="content">
        ...
        <div class="timeline-post">
          <div class="post-media"><a href="#"><img class="img" src="https://lh3.googleusercontent.com/proxy/KfiKetdwqV8ZzSGvjJKrAvpGzp7Rq7pJK3XLeL_KgRgsdqdCPgwgD79Y7nVaUqsrX-8r6nUhp3_3tWL0XLNTGpxjnoTW-GY"></a>
            <div class="content">
              <h5><a href="#">John Doe</a></h5>
              <p class="text-muted"><small>2 January at 9:30</small></p>
            </div>
